...
const remainingRouter: AppRouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      {
        path: 'dify',
        component: () => import('@/views/infra/file/dify/index.vue'),
        name: 'InfraFileDify',
        meta: {
          noCache: true,
          hidden: true,
      ...
      {
        path: 'dataset',
        component: () => import('@/views/infra/file/dify/dataset.vue'),
        name: 'InfraFileDifyDataset',
        meta: {
          noCache: true,
          hidden: true,
          canTo: true,
      ...
      {
        path: 'chat',
        component: () => import('@/views/infra/file/dify/chat.vue'),
        name: 'InfraFileDifyChat',
        meta: {
          noCache: true,
          hidden: true,
          canTo: true,
