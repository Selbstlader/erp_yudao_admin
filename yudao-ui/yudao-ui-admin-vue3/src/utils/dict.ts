...
export enum DICT_TYPE {
  ...
  INFRA_DIFY_PERMISSION = 'infra_dify_permission', // Dify知识库权限类型
  INFRA_DIFY_INDEXING_TECHNIQUE = 'infra_dify_indexing_technique', // Dify知识库索引技术
  INFRA_DIFY_SYNC_STATUS = 'infra_dify_sync_status', // Dify知识库同步状态
